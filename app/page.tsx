...
export default function Home() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      quote:
        "Aljon has constantly shown that he is a reliable employee by showing up for work each day prepared and with a positive attitude.",
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6 grow">
        ...
        <Card isDark={isDark} className="col-span-1 lg:col-span-3">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start justify-center md:justify-start">
            <div
              className={`relative w-32 h-32 md:w-40 md:h-40 rounded-2xl overflow-hidden border-4 shrink-0 ${isDark ? "border-neutral-800" : "border-neutral-100"}`}
            >
              <Image
                src="/profile.jpg"
                alt="Al-jon Santiago"
            ...
            <div className="flex-1 text-center md:text-left space-y-4 pt-2">
              <div>
                ...
                <p
                  className={`flex items-center justify-center md:justify-start gap-2 text-sm ${isDark ? "text-neutral-400" : "text-neutral-500"}`}
                >
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 pt-2">
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=aljons702@gmail.com"
                  target="_blank"
                ...
                <div
                  className={`hidden md:block h-8 w-px mx-1 ${isDark ? "bg-neutral-800" : "bg-neutral-200"}`}
                ></div>

                <a
                  href="https://github.com/Aljon0"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-lg transition-colors border ${isDark ? "border-neutral-800 hover:bg-neutral-800 text-neutral-400 hover:text-white" : "border-neutral-200 hover:bg-neutral-100 text-neutral-500 hover:text-black"}`}
                >
                  <Github size={18} />
                  <span className="font-medium">GitHub</span>
                </a>
                <a
                  href="https://www.linkedin.com/in/santiago-al-jon-b-31a478281/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-lg transition-colors border ${isDark ? "border-neutral-800 hover:bg-neutral-800 text-neutral-400 hover:text-white" : "border-neutral-200 hover:bg-neutral-100 text-neutral-500 hover:text-black"}`}
                >
          ...
          <Link href="/tech-stack" className="block group">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <ArrowUpRight
                  size={18}
                  className={`transition-transform group-hover:translate-x-1 group-hover:-translate-y-1 ${isDark ? "text-neutral-400" : "text-neutral-500"}`}
                />
              </div>
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tech}
                    className={`px-3 py-1.5 rounded-md text-xs font-medium border ${isDark ? "bg-neutral-800 border-neutral-700 text-neutral-300" : "bg-neutral-100 border-neutral-200 text-neutral-700"}`}
                  >
                    {tech}
                  </span>
                ))}
                <span
                  className={`px-3 py-1.5 text-xs opacity-50 ${isDark ? "text-neutral-400" : "text-neutral-500"}`}
                >
                  + many more
                </span>
              </div>
        ...
        <div className="col-span-1 space-y-6">
          ...
          <Card isDark={isDark} className="h-fit">
            ...
            <div
              className={`relative border-l ml-2 space-y-10 pb-2 ${isDark ? "border-neutral-800" : "border-neutral-200"}`}
            >
              {[
                {
                ...
                <div key={i} className="ml-8 relative">
                  <span
                    className={`absolute -left-9.25 top-1.5 h-3 w-3 rounded-full border-4 ${isDark ? "bg-neutral-800 border-neutral-900" : "bg-neutral-400 border-white"}`}
                  />
                  <h4 className="font-semibold text-sm">{job.role}</h4>
                  <p className="text-xs opacity-60 mb-1">{job.company}</p>
                  <div
                    className={`inline-block px-2 py-0.5 rounded text-[10px] font-mono ${isDark ? "bg-neutral-800 text-neutral-400" : "bg-neutral-100 text-neutral-500"}`}
                  >
                    {job.year}
                  </div>
                </div>
          ...
          <Link href="/certifications" className="block group">
            ...
            >
              ...
              <div className="flex items-center gap-4 p-3 rounded-lg border transition-colors">
                {/* Updated to Scrimba / Mistral AI */}
                <div className="h-10 w-10 bg-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-sm shrink-0">
                  S
                </div>
                <div>
                  <p className="font-semibold text-sm">Scrimba</p>
                  <p className="text-xs opacity-60">Intro to Mistral AI</p>
                </div>
              </div>
            </Card>
          </Link>
          ...
          <Card isDark={isDark}>
            ...
            <p
              className={`text-xs mb-4 leading-relaxed ${isDark ? "text-neutral-400" : "text-neutral-600"}`}
            >
              When I&apos;m not on the clock, I&apos;m deep diving into
              documentation or testing bleeding-edge tools to optimize my
              workflow.
            </p>

            <div className="grid grid-cols-2 gap-3">
              <div
                className={`p-3 rounded-lg border ${isDark ? "bg-neutral-800/30 border-neutral-800" : "bg-neutral-50 border-neutral-100"}`}
              >
        ...
        <Card isDark={isDark} className="col-span-1 lg:col-span-3">
          ...
          <div className="relative h-60 md:h-60 flex items-center justify-center">
            {testimonials.map((t, index) => (
              ...
              >
                <div className="shrink-0">
                  <div
                    className={`w-16 h-16 rounded-xl flex items-center justify-center overflow-hidden border ${isDark ? "bg-white border-neutral-700" : "bg-white border-neutral-200"}`}
                  >
                    {t.hasImage ? (
                      <Image
                        src={t.image!}
                ...
                <div className="flex-1">
                  <p
                    className={`text-sm md:text-base italic leading-relaxed mb-4 ${isDark ? "text-neutral-300" : "text-neutral-600"}`}
                  >
                    &quot;{t.quote}&quot;
                  </p>
                  <div>
